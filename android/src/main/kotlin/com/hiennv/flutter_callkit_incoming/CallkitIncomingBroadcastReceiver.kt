...
private fun Bundle.toData(): Map<String, Any?> {
    val android = mapOf(
        ...
        "isImportant" to getBoolean(CallkitConstants.EXTRA_CALLKIT_IS_IMPORTANT, true),
    ...
    val callingNotification = mapOf(
        ...
        "showNotification" to getBoolean(CallkitConstants.EXTRA_CALLKIT_CALLING_SHOW),
        ...
        "isShowCallback" to getBoolean(CallkitConstants.EXTRA_CALLKIT_CALLING_HANG_UP_SHOW),
    )
    return mapOf(
        ...
        "acceptColor" to getString(CallkitConstants.EXTRA_CALLKIT_ACCEPT_COLOR, ""),
        "declineColor" to getString(CallkitConstants.EXTRA_CALLKIT_DECLINE_COLOR, ""),
